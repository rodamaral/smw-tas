...
smw.OSCILLATION_SPRITES = lua_general.make_set{0x0e, 0x21, 0x29, 0x35, 0x54, 0x74, 0x75, 0x76, 0x77, 0x78, 0x81, 0x83, 0x87}

-- Sprites that have a custom hitbox drawing
smw.ABNORMAL_HITBOX_SPRITES = lua_general.make_set{0x62, 0x63, 0x6b, 0x6c}

-- Sprites whose clipping interaction points usually matter
smw.GOOD_SPRITES_CLIPPING = lua_general.make_set{
...
smw.UNINTERESTING_EXTENDED_SPRITES = lua_general.make_set{1, 7, 8, 0x0e, 0x10, 0x12}
