...
local gui,
  ...
  get_file_type = _G.gui, _G.get_directory_contents, _G.get_file_type
...
-- Font settings:
M.LSNES_FONT_WIDTH = 8
M.LSNES_FONT_HEIGHT = 16
M.BIZHAWK_FONT_WIDTH = 10
M.BIZHAWK_FONT_HEIGHT = 14
...
M.BMP_STRINGS.player_blocked_status =
  ...
  'KGCIWBj4+Pj4QHBAgJj42HDYoDiA2MggMIipQuZJAAAAfElEQVR4nGNgYGAQFBRgAFHllYVA' ..
    'irHcZWUikBYpcQCJMrqAKQZGBQYDAwMGBqEgZgUF1QAG4SAGJSUlVQYBIyYFY2NTBgZmI7A6' ..
      'BtZgY4gG19AYEC3i3rH7AJAWDW3LzgHSYWlhEDq1o3sPhD4BkmcNDQgAawyN5GSAAwCQmRc/' .. 's4Su8AAAAABJRU5ErkJggg=='
...
M.BMP_STRINGS.interaction_points[2] =
  ...
  'AnRSTlMA/1uRIrUAAAAnSURBVHicY2CgOjiAlyAOMH9g/gAhsJoMFodIkmoy8bZhAQaHcRMA' .. 'xDoWseuRDbIAAAAASUVORK5CYII='
M.BMP_STRINGS.interaction_points[3] =
  'iVBORw0KGgoAAAANSUhEUgAAABwAAABiAQMAAAB56yFmAAAABlBMVEUAAAD///+l2Z/dAAAA' ..
  'AnRSTlMA/1uRIrUAAAAqSURBVHicY2AY4uAAXgIfYP7A/AFCEDAZrAKijDiTKQGEXIUXGBzG' .. 'TQAAyrMWsYAl5OUAAAAASUVORK5CYII='
M.BMP_STRINGS.interaction_points[4] =
  'iVBORw0KGgoAAAANSUhEUgAAABwAAABiAQMAAAB56yFmAAAABlBMVEUAAAD///+l2Z/dAAAA' ..
  'AnRSTlMA/1uRIrUAAAAqSURBVHicY2AY9OAAXgIfYP7A/AFCEDAZrAKijDiTaQcIuRkvMDiM' .. 'mwAAVq0WsankG3YAAAAASUVORK5CYII='

--[[ test
M.BMP_STRINGS.interaction_points[1] = gui.image.load_png("hitbox/interaction_points_1.png", images_folder)
M.BMP_STRINGS.interaction_points[2] = gui.image.load_png("hitbox/interaction_points_2.png", images_folder)
M.BMP_STRINGS.interaction_points[3] = gui.image.load_png("hitbox/interaction_points_3.png", images_folder)
M.BMP_STRINGS.interaction_points[4] = gui.image.load_png("hitbox/interaction_points_4.png", images_folder)
--]]
-- Symbols
M.LEFT_ARROW = '<-'
M.RIGHT_ARROW = '->'
...
local function color_number(str)
  ...
  r,
    g,
    b,
    a = tonumber(r, 16), tonumber(g, 16), tonumber(b, 16), tonumber(a, 16)
...
local function interpret_color(data)
...
function M.load_options(filename)
  M.OPTIONS =
    luap.file_exists(filename) and
    M.retrieve(filename, {[OPTIONS_LABEL .. ' OPTIONS'] = M.DEFAULT_OPTIONS})[OPTIONS_LABEL .. ' OPTIONS'] or
    luap.copytable(M.DEFAULT_OPTIONS)

  M.COLOUR =
    luap.file_exists(filename) and
    M.retrieve(filename, {[OPTIONS_LABEL .. ' COLOURS'] = M.DEFAULT_COLOUR})[OPTIONS_LABEL .. ' COLOURS'] or
    luap.copytable(M.DEFAULT_COLOUR)

  M.save(
    filename,
    {
      [OPTIONS_LABEL .. ' OPTIONS'] = M.OPTIONS,
      [OPTIONS_LABEL .. ' COLOURS'] = M.COLOUR
    }
  )
...
function M.load_lsnes_fonts(folder)
