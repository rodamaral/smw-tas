    ...
    if OPTIONS.display_extended_sprite_info then
      ...
      if u8('WRAM', WRAM.spinjump_flag) ~= 0 and playerPowerup == 3 then
        ...
        draw.text(
          ...
          yText,
          fmt('%d %s', fireball_timer % 16, bit.test(fireball_timer, 4) and RIGHT_ARROW or LEFT_ARROW),
          COLOUR.extended_sprites,
          true,
          false,
          1.0,
