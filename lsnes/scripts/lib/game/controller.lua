...
function M.display()
    ...
    x = draw.over_text(x, y, memory2.BUS:word(0x4218), 'BYsS^v<>AXLR0123', COLOUR.warning, false,
                       true)
    x = draw.over_text(x, y, memory2.BUS:word(0x421a), 'BYsS^v<>AXLR0123', COLOUR.warning2, false,
                       true)
    x = draw.over_text(x, y, memory2.BUS:word(0x421c), 'BYsS^v<>AXLR0123', COLOUR.warning, false,
                       true)
    x = draw.over_text(x, y, memory2.BUS:word(0x421e), 'BYsS^v<>AXLR0123', COLOUR.warning2, false,
                       true)
    _, y = draw.text(x, y, ' (Registers)', COLOUR.warning, false, true)

    x = x_pos
    x = draw.over_text(x, y, memory2.BUS:word(0x4016), 'BYsS^v<>AXLR0123', COLOUR.warning, false,
                       true)
